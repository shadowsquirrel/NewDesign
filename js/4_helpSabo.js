...
debug.start.GMHS1 = function(treatment) {
    ...
    // close the box
    box.transition('', 'HSINTRO-1', 0, 0, 1, 1300);
    ...
    setTimeout(()=>{
        ...
        title.update.text('GAME MECHANICS');
        title.update.size(true);
        $('#boxbox-HSINTRO').css({'display':'block'})
    }, 800)

    setTimeout(()=>{
        box.button.show('HSINTRO-1');
    }, 2750)
...
$('#btn-HSINTRO-1').click(function() {
    ...
    setTimeout(()=>{
        // $('.generalMarginBox').css({'transition':'0s', 'margin-top':'-40px'});
    ...
    // close the box
    box.transition('HSINTRO-1', 'HS1-1', 0, 0, 1, 1500);
...
$('#btn-HS1-2').click(function() {
    ...
    // close the box
    box.transition('HS1-2', 'HS1-201', -341, 0, 1, 750);

    calculator.lock.activate([0,0,0,0,0,0]);

    setTimeout(()=>{
        box.button.show('HS1-201');
    }, 3000)

})

$('#btn-HS1-201').click(function() {

    // close the box
    box.transition('HS1-201', 'HS1-3', 0, 0, 1, 3250);
    ...
    setTimeout(()=>{
        calculator.animate.increment = 2;
        calculator.change.f1(0,6, 0);
        setTimeout(()=>{
...
$('#btn-HS1-401').click(function() {
    ...
    $('#box-HS1-401').css({'margin-left':'473px'})
...
$('#btn-HS1-5').click(function() {
    ...
    $('.experimentalText').css({'transition':'1s', 'margin-top':'628px', 'margin-left':'-102px',
    'width':'853px'});
    setTimeout(()=>{
        $('#advTextInfoBox2').css({'display':'contents'});
        setTimeout(()=>{
            $('#advTextInfoBox2').css({'transition':'1s', 'opacity':'1'});
        }, 250)
    }, 1000)
    ...
    box.transition('HS1-5', 'HS1-501', -189, 0, 1,750);

    setTimeout(()=>{
        box.button.show('HS1-501');
    }, 3000)

})

$('#btn-HS1-501').click(function() {

    $('.experimentalText').css({'transition':'1s', 'margin-top':'847px', 'margin-left':'-102px',
    'width':'853px'});



    box.transition('HS1-501', 'HS1-502', 1, 0, 1,750);

    setTimeout(()=>{
        box.button.show('HS1-502');
    }, 3000)

})

$('#btn-HS1-502').click(function() {

    box.transition('HS1-502', 'HS1-6', 0, 0, 1,1250);
...
$('#btn-HS1-6').click(function() {
    ...
    box.transition('HS1-6', 'HS1-601', 0, 0, 1, 750);
    ...
    setTimeout(()=>{
        box.button.show('HS1-601');
    }, 3000)

})

$('#btn-HS1-601').click(function() {

    box.transition('HS1-601', 'HS1-7', 0, 0, 1, 750);
    calculator.introduce.pointerCostActive = false;
    // title.update.size(false);
...
// this logic lock will be used either in the below or the
// one after depending on the treatment
...
$('#btn-HS1-7').click(function() {
    ...
    if(!box.global.symmetricHeteroTreatment && !box.global.asymmetricHeteroTreatment){
        ...
        // box.transition('HS1-7', 'HS1-8', 0, 0, 1, 750);
        //
        // setTimeout(()=>{
        //     calculator.pointers.activate([0,0,1,1,0,0]);
        //     listener.hs1_8_f1 = true;
        //     listener.hs1_8_f2 = true;
        // }, 1250)
    ...
    } else { //hetero symm and asymm treatment

        box.transition('HS1-7', 'HS1-7A', 0, 0, 1, 750);

        setTimeout(()=>{
            calculator.introduce.onlyCosts();
            calculator.introduce.pointerCostActive2 = true;
            calculator.introduce.pointerCost2(0);
        }, 750)

        calculator.values.set.helpSabo([0,0,9,9,0,0,0,0]);
        calculator.refresh.sliders();
        calculator.introduce.costs();

        setTimeout(()=>{
            calculator.values.set.helpSabo([12,12,0,0,0,0,0,0]);
            calculator.refresh.sliders();
            calculator.introduce.costs();
        }, 3750)
...
// hetero symm and asymm treatment specific info box
$('#btn-HS1-7A').click(function() {

    // box.transition('HS1-7A', 'HS1-8', 0, 0, 1, 750);
    //
    // calculator.introduce.pointerCostActive2 = false;
    ...
    // box.transition('HS1-7A', 'HS1-91', 0, 0, 1, 2000);
    box.transition('HS1-7A', 'HS1-91', 0, 0, 1, 750);
...
var funWithSliders1 = function(delay) {

    // setTimeout(()=>{
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([0,0,0,0, 0,0,0,0]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([5,5,0,0, 5,5,0,0]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 2 * delay)
    ...
    setTimeout(()=>{
        // setup the predefine values except
        // s1,s2,h1,h2,os1,os2,oh1,oh2
        calculator.values.set.helpSabo([10,10,0,0, 10,10,0,0]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 1,1, 1,1]);
    }, 1 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([5,15,0,0, 15,5,0,0]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 4 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([15,5,0,0, 5,15,0,0]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 5 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([0,0,5,5, 0,0,5,5]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 8 * delay)
    ...
    setTimeout(()=>{
        // setup the predefine values except
        // s1,s2,h1,h2,os1,os2,oh1,oh2
        calculator.values.set.helpSabo([0,0,10,10, 0,0,10,10]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 1,1, 1,1]);
    }, 2 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([0,0,5,15, 0,0,5,15]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 10 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([0,0,15,5, 0,0,15,5]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 11 * delay)
...
var funWithSliders2 = function(delay) {

    setTimeout(()=>{
        // setup the predefine values except
        // s1,s2,h1,h2,os1,os2,oh1,oh2
        calculator.values.set.helpSabo([0,10,10,0, 0,10,10,0]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 1,1, 1,1]);
    }, 1 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([0,5,5,0, 0,5,5,0]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 3 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([20,0,0,20, 20,0,0,20]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 4 * delay)
    ...
    //     // setup the predefine values except
    //     // s1,s2,h1,h2,os1,os2,oh1,oh2
    //     calculator.values.set.helpSabo([1,0,0,1, 1,0,0,1]);
    //     calculator.refresh.sliders();
    //     calculator.introduce.costs();
    //     calculator.lock.activate([0,0, 1,1, 1,1]);
    // }, 6 * delay)
...
calculator.myFunDelay2 = 1000;
calculator.animateCombo = true;
var funWithSlidersCombo = function(state) {

    if(calculator.animateCombo) {

        if(state === 0) {
            funWithSliders1(calculator.myFunDelay2);
            setTimeout(()=>{
                funWithSlidersCombo(1);
            }, 3 * calculator.myFunDelay2)
        }

        if(state === 1) {
            funWithSliders2(calculator.myFunDelay2);
            // setTimeout(()=>{
            //     calculator.lock.activate([0,0, 0,0, 0,0]);
            //     // funWithSlidersCombo(0);
            // }, 8 * calculator.myFunDelay2)
        }
...
calculator.myFunDelay = 400;
calculator.animateFunSliders = true;
var funWithSliders3 = function() {

    if(calculator.animateFunSliders) {
        ...
        setTimeout(()=>{
            ...
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 1 * calculator.myFunDelay)

        setTimeout(()=>{
            // setup the predefine values except
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([0,0,5,5, 5,5,0,0]);
            calculator.refresh.sliders();
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 2 * calculator.myFunDelay)


        setTimeout(()=>{
            // setup the predefine values except
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([0,0,10,10, 10,10,0,0]);
            calculator.refresh.sliders();
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 3 * calculator.myFunDelay)
        ...
        setTimeout(()=>{
            ...
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 5 * calculator.myFunDelay)

        setTimeout(()=>{
            // setup the predefine values except
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([5,5,0,0, 0,0,5,5]);
            calculator.refresh.sliders();
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 6 * calculator.myFunDelay)

        setTimeout(()=>{
            // setup the predefine values except
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([10,10,0,0, 0,0,10,10]);
            calculator.refresh.sliders();
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 7 * calculator.myFunDelay)
        ...
        setTimeout(()=>{
            ...
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 1,1, 1,1]);
        }, 8 * calculator.myFunDelay)

        setTimeout(()=>{
            funWithSliders3()
        }, 9 * calculator.myFunDelay)
    } else {
        calculator.values.set.helpSabo([0,0,0,0, 0,0,0,0]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
...
$('#btn-HS1-92').click(function() {
    ...
    // funWithSliders3();
    // setTimeout(()=>{
    //     calculator.animateFunSliders = false;
    // }, 5000)
...
$('#btn-HS1-93').click(function() {
    ...
    // setTimeout(()=>{
    //
    //     calculator.pointers.activate([0,0,1,1,1,1]);
    //     listener.hs1_10_f1 = true;
    //     listener.hs1_10_f2 = true;
    //     listener.hs1_10_of1 = true;
    //     listener.hs1_10_of2 = true;
    //
    // }, 750)
    ...
    setTimeout(()=>{
        calculator.values.set.helpSabo([0,0,9,10,0,0,10,10]);
        calculator.animate.increment = 3;
        calculator.change.f1(3,0)
    }, 4000)
...
$('#btn-HS1-10').click(function() {

    box.transition('HS1-10', 'HS1-11', 0, 0, 1, 750);
    ...
    setTimeout(()=>{
        box.button.show('HS1-11');
    }, 5500)

})

$('#btn-HS1-11').click(function() {

    box.transition('HS1-11', 'HS1-12', 0, 0, 1, 750);

    calculator.lock.activate([0,0,1,1,1,1]);
    calculator.values.set.helpSabo([0,0,9,9,0,0,9,9]);
    calculator.refresh.sliders();
    calculator.introduce.costs();
...
$('#btn-HS1-12').click(function() {
    ...
    setTimeout(()=>{
        calculator.lock.activate([0,0,1,1,1,1]);
        calculator.values.set.helpSabo([s1,s2,h1,h2,0,os2,9,oh2]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.animate.recallDelay = 1;
        calculator.animate.increment = 3;
        calculator.change.of1(15,0)
    }, 1250)

    box.transition('', 'HS2-1', 0, 0, 1, 3500);
...
$('#btn-HS2-1').click(function() {
    ...
    setTimeout(()=>{
        box.transition('', 'HS2-100', 0, 0, 1, 0);
        calculator.lock.activate([0,0,0,0,0,0]);
        calculator.pointers.activate([0,0, 1,1, 1,1]);
        listener.hs2_100_f1 = true;
        listener.hs2_100_f2 = true;
        listener.hs2_100_of1 = true;
        listener.hs2_100_of2 = true;
    }, 2000)
...
$('#btn-HS2-101').click(function() {
    ...
    box.transition('HS2-101', 'HS2-10101', 0, 0, 1, 750);

    setTimeout(()=>{
        box.button.show('HS2-10101');
    }, 3500)

})

$('#btn-HS2-10101').click(function() {

    box.transition('HS2-10101', 'HS2-10103', 0, 0, 1, 750);
...
// FROM HERE GO TO HS2-9
// listener.hs2_9_f2 IS ACTIVATED
$('#btn-HS2-10103').click(function() {

    minimizeFunction();

    box.transition('HS2-10103', 'HS2-9', 0, 0, 1, 1750);
    ...
    setTimeout(()=>{
        ...
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 1,0, 1,1]);
        calculator.questions.activate.all([1,0,1,0,1,1]);
    }, 1000)

    setTimeout(()=>{
        // lock the sliders except follower 1
        calculator.pointers.activate([0,0, 0,1, 0,0]);
        listener.hs2_9_f2 = true;
    }, 2750)
...
$('#btn-HS2-2').click(function() {

    // calculator.hide.checkMark();
    minimizeFunction();

    box.transition('HS2-2', 'HS2-5', 0, 0, 1, 1750);
...
$('#btn-HS2-3').click(function() {
    ...
    box.transition('HS2-3', 'HS2-4', 0, 0, 1, 1750);

    setTimeout(()=>{
        // setup the predefine values except
        // s1,s2,h1,h2,os1,os2,oh1,oh2
        calculator.values.set.helpSabo([0,0,0,21, 5,0,0,11]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 0,1, 1,1]);
    }, 1000)
...
$('#btn-HS2-4').click(function() {
    ...
    box.transition('HS2-4', 'HS2-5', 0, 0, 1, 1750);
...
$('#btn-HS2-6').click(function() {
    ...
    box.transition('HS2-6', 'HS2-7', 0, 0, 1, 1750);

    setTimeout(()=>{
        // setup the predefine values except
        // s1,s2,h1,h2,os1,os2,oh1,oh2
        calculator.values.set.helpSabo([0,5,0,0, 2,3,0,0]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 0,1, 1,1]);
    }, 1000)
...
$('#btn-HS2-701').click(function() {
    ...
    if(!box.global.symmetricHeteroTreatment && !box.global.asymmetricHeteroTreatment){
        ...
        box.transition('HS2-701', 'HS2-12A4', 0, 0, 1, 750);
        ...
        box.transition('HS2-701', 'HS2-12A1', 0, 0, 1, 2750);
        ...
        setTimeout(()=>{
            // setup the predefine values except
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([0,0,0,17, 3,0,0,7]);
            calculator.refresh.sliders();
            calculator.introduce.costs();
            calculator.lock.activate([0,0, 0,1, 1,1]);
        }, 1000)
...
// NOT USED INSTEAD TRIGGERD ON EVENT
$('#btn-HS2-8').click(function() {

    calculator.hide.checkMark();
    minimizeFunction();

    box.transition('HS2-8', 'HS2-9', 0, 0, 1, 1750);
...
$('#btn-HS2-81').click(function() {
    ...
    box.transition('HS2-81', 'HS2-9', 0, 0, 1, 1750);
...
// these listeners are not use hs2-10
// instead activates hs2_12_f2

listener.hs2_11_f2 = false;
activator.hs2_11_f2 = false;
$('#btn-HS2-10').click(function() {
    ...
    box.transition('HS2-10', 'HS2-11', 0, 0, 1, 1750);

    setTimeout(()=>{
        // setup the predefine values except
        // s1,s2,h1,h2,os1,os2,oh1,oh2
        calculator.values.set.helpSabo([0,0,5,0, 0,0,4,1]);
        calculator.refresh.sliders();
        calculator.introduce.costs();
        calculator.lock.activate([0,0, 1,0, 1,1]);
    }, 1000)
...
$('#btn-HS2-1101').click(function() {

    box.transition('HS2-1101', 'HS2-5', 0, 0, 1, 2750);
    ...
    calculator.refresh.values();
    calculator.roll.resetRoll();
    calculator.questions.activate.all([0,1,1,0,1,1]);
...
$('#btn-HS2-121').click(function() {
    ...
    if(!box.global.symmetricHeteroTreatment && !box.global.asymmetricHeteroTreatment){
        ...
        box.transition('HS2-121', 'HS2-12A4', 0, 0, 1, 750);
        ...
        box.transition('HS2-121', 'HS2-12A1', 0, 0, 1, 2750);
...
$('#btn-HS2-12A2').click(function() {
    ...
    box.transition('HS2-12A2', 'HS2-12A4', 0, 0, 1, 750);
...
$('#btn-HS2-12A5').click(function() {

    box.transition('HS2-12A5', 'HS2-12A6', 0, 0, 1, 750);
    ...
    setTimeout(()=>{
        box.button.show('HS2-12A6');
    }, 5000)

})

$('#btn-HS2-12A6').click(function() {

    calculator.hide.checkMark();

    $('.OG1GroupSeparator').css({'transition':'0s', 'opacity':'0', 'height':'0px'});

    box.transition('HS2-12A6', '', 0, 0, 1, 750);
    setTimeout(()=>{
        $('#boxbox-HS2, #boxbox-HSINTRO').css({'display':'none'});
        $('#boxbox-LC1').css({'display':'block'});
    }, 750)

    // make the hs and pbar dissapear
    setTimeout(()=>{
    ...
    // making sure that these box wraps are closed
    setTimeout(()=>{
...
$('#vSlider1').change(function() {
    ...
    if(listener.hs2_5_f1 && (s1 >= 2 && s1 <= 10)) {
        // console.log('correct value picked');
    ...
    if(listener.hs2_8_f2 && (s1 >= 20 && s1 <= 30)) {
        // console.log('correct value picked');
    ...
    if(activator.hs2_8_f2) {
        ...
        setTimeout(()=>{
            ...
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([24,5,0,0,2,3,0,0]);
            calculator.refresh.sliders();
    ...
    if(listener.hs2_12A1_f1 && (s1 >= 7 && s1 <= 20)) {
        // console.log('correct value picked');
    ...
    if(activator.ls2_16_f1) {
        ...
        setTimeout(()=>{
            ...
            box.transition('LC2-16', 'LC2-1601', 0, 0, 1, 750);
...
$('#vSlider2').change(function() {
    ...
    if(listener.hs2_9_f2 && (h2 >= 2 && h2 < 10)) {
        // console.log('correct value picked');
    ...
    if(activator.hs2_9_f2) {
        ...
        setTimeout(()=>{
            calculator.lock.activate([0,0,0,1,0,0]);
        }, 500)
        ...
        setTimeout(()=>{
            ...
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([0,0,0,4,0,0,0,0]);
            calculator.refresh.sliders();
    ...
    if(listener.hs2_12_f2 && (h2 >= 20 && h2 <= 30)) {
        // console.log('correct value picked');
    ...
    if(activator.hs2_12_f2) {
        ...
        setTimeout(()=>{
            ...
            // s1,s2,h1,h2,os1,os2,oh1,oh2
            calculator.values.set.helpSabo([0,0,5,24,0,0,3,2]);
            calculator.refresh.sliders();
