...
// OLD VERSION WITH POWER AND RATIO FUNCTIONS
...
//OLD VERSION WITH SLIGHT PARAMETER ADDITIONS
// This is the optimized version as far as I can code
// calculator.icons.calculate.size = function(h, s) {
//
//     var p = 0.001;
//     var l = 0.2;
...
//     var k = 0.14;//0.2
//
//     var m = (l + Math.pow(hRatio, k)) / (l + Math.pow(sRatio, k));
//
//
//     console.log('hratio: ' + hRatio);
//     console.log('sratio: ' + sRatio);
//     console.log('size multiplier: ' + m);
//
//
//     return m;
//
...
// NEW VERSION WITH LOGISTIC FUNCTION EASIER TO ADJUST CURVATURE
/*
// calculator.icons.calculate.size = function(h, s) {
//
//     var L = 2;//2; //1.85;
...
//     var k = 0.37;
//
//     var hRatio = L / (1 + Math.exp(-k * (h - x0)));
//     var sRatio = L / (1 + Math.exp(-k * (s - x0)));
//
//     var m = hRatio / sRatio;
//
//     console.log(m);
...
//     var actualH = (1 + h);
//     var actualS = (1 + s);
//     var actualM = actualH / actualS;
//
//     var m = L / (1 + Math.exp(-k * (actualM - x0)));
//
//
//
//     console.log('logistic m: ' + m);
//
//     return m;
//
// }
...
debug.start.OG2 = function(treatment) {
    ...
    $('#boxbox-IG').css({'transition':'0.3s','margin-bottom':'-20px'});
    setTimeout(()=>{
        $('#boxbox-IG').css({'display':'none'});
    }, 300);

    $('#boxbox-IG2').css({'transition':'0.3s','margin-bottom':'-20px'});
    setTimeout(()=>{
    ...
    setTimeout(()=>{
        $('#boxbox-IG2').css({'display':'none'});
        $('#boxbox-OG2Intro').css({'display':'block'});
    }, 750)

    // Hide map
    setTimeout(()=>{
        $('.sexplain').css({'transition':'1s', 'transform':'scaleY(0)', 'height':'0px', 'margin-bottom':'-180px'});
        setTimeout(()=>{
            $('.sexplain').css({'display':'none'});
            $('.IGCoverTop').css({'margin-top':'-55px'});
            $('.IGCoverBottom').css({'margin-top':'230px'});
            map.tutorial.result.reset()
            map.closeSpace();
            ...
            map.opacity.section([1,1,1]);
            calculator.tutorial.rotateSectionCoverIsOn = true;
            calculator.tutorial.rotateSectionCover(0);
            $('.IGBottomContestWrap, .IGTopContestWrap').css({'transition':'scale(1)', 'filter':'opacity(1)'});
    ...
    setTimeout(()=>{
        ...
        setTimeout(()=>{
            ...
            title.update.textColor(-5550, true, 30);
            title.update.text('OUT-GROUP CONTEST II');
            title.update.size(true);
        }, 1350)
    }, 750)

    setTimeout(()=>{
        $('.sexplain').css({'transition':'0s', 'display':'flex', 'margin-bottom':'-30px', 'opacity':'0', 'height':'0px', 'transform':'scaleY(0)'});
        setTimeout(()=>{
            $('.sexplain').css({'transition':'1s', 'transform':'scaleY(1)', 'height':'185px', 'margin-bottom':'20px', 'margin-top':'30px', 'opacity':'1'});
        }, 250)
    }, 2500)

    // Show new info box
    setTimeout(()=>{
        box.transition('', 'OG2Intro-1', 0, 0, 1, 0);
    }, 3500)
...
$('#btn-OG2Intro-1').click(function() {

    box.transition('OG2Intro-1', 'OG2Intro-3', 0, 0, 1, 3000);
    ...
    setTimeout(()=>{
        ...
        calculator.tutorial.animateOG2mapActive = 0;
        ...
        setTimeout(()=>{
            ...
            setTimeout(()=>{
                $('.OG1FightIconLime, .IGFightIconLimeTop, .IGFightIconLimeBottom').css({'transition':'0.5s', 'opacity':'0'});
                $('.IGFI_Top, .IGFI_Bottom').css({'transition':'0.5s', 'opacity':'0'});
                $('.resultsUnknown').css({'transition':'1s', 'opacity': '0'});
                $('.wonLostBoxes').css({'transition':'1s','opacity':'1'});
                $('.arrowToTopIconResults, .arrowToBottomIconResults').css({'transition':'1s', 'opacity':'1'});
                $('.OG1LeaderLeft, .OG1LeaderRight, .OG1FightIconWrap').css({'transition':'1s', 'opacity':'0'});
                $('.topBoxLeaderResult, .bottomBoxLeaderResult').css({'transition':'1s', 'opacity':'1'});
                $('.arrowDashed').css({'transition':'0.5s', 'opacity':'0'});
                map.winnerLeaderIndex = 2;
                map.set.OG1ResultIcons();
            }, 1000)
    ...
    setTimeout(()=>{
        box.button.show('OG2Intro-3');
    }, 5000)

})

$('#btn-OG2Intro-101').click(function() {

    $('.IGFightIcon, .IGFightIconLimeBottom, .IGFightIconLimeTop, .OG1FightIcon, .OG1FightIconLime').css({'transition':'0s', 'transform':'rotate3d(3,2,1, 0deg)'});
    calculator.tutorial.rotateSectionCoverDelay = 0;
    calculator.tutorial.animateOG2mapActive = 0;
    ...
    map.opacity.section([0,0,0], 1);
    map.animate.helpSabotage4Setup();
    map.animate.OG1ResultsUknown(0.5);


    setTimeout(()=>{
        map.opacity.main([1,0.5,0.2],2)
        map.opacity.section([0.2,0.5, 0.5], 1)
    }, 750)

    box.transition('OG2Intro-101', 'OG2Intro-102', 0, 0, 1, 1500);

    setTimeout(()=>{
        box.button.show('OG2Intro-102');
    }, 4000)

})

$('#btn-OG2Intro-102').click(function() {

    // animate from the previous section
    map.animate.helpSabotage5(0)
    map.opacity.main([1,1,0.2],2)
    map.opacity.section([0.2,0.2, 0.5], 1)

    box.transition('OG2Intro-102', 'OG2Intro-2', 0, 0, 1, 750);

    setTimeout(()=>{
        box.button.show('OG2Intro-2');
    }, 10000)

})

$('#btn-OG2Intro-2').click(function() {

    box.transition('OG2Intro-2', 'OG2Intro-3', 0, 0, 1, 750);
...
$('#btn-OG2Intro-3').click(function() {

    calculator.tutorial.animateOG2mapActive = 0;

    map.opacity.main([1, 1, 0.6], 2);

    box.transition('OG2Intro-3', 'OG2Intro-4', 0, 0, 1, 3000);
    if(!box.global.symmetricHeteroTreatment && !box.global.asymmetricHeteroTreatment) {
        $('#anotherIdToCall-20').css({'display':'none'});
        $('#anotherIdToCall-21').css({'display':'block'});
    } else {
        $('#anotherIdToCall-21').css({'display':'none'});
        $('#anotherIdToCall-20').css({'display':'block'});
    }
    ...
    setTimeout(()=>{
        $('.prizeCrownLimeTop').css({'transition':'0.5s', 'opacity':'1', 'margin-top':'-36px'});
        $('.prizeCrownBlackTop, .IGFightIconLimeTop').css({'transition':'0.5s', 'opacity':'0'});
        $('.OG1LeftFollower1, .OG1LeftFollower2').css({'transition':'0.5s', 'opacity':'0.4'});
        $('.IGFI_Top, .IGFI_Bottom').css({'transition':'0.5s', 'opacity':'0'});
        $('.arrowDashed').css({'transition':'0.5s', 'opacity':'0'});
    ...
    setTimeout(()=>{
        ...
        $('.prizeCrownLimeTop').css({'transition':'0.5s', 'margin-top':'-51px', 'margin-left': '-40px', 'height':'27px', 'width':'29px', 'z-index':'0'});
        $('.arrowDashed').css({'transition':'0.5s', 'opacity':'0'});
        $('.IGBottomContestWrap').css({'transition':'0.5s','opacity':'0.7'});
        $('.mapdiscardedXBottom').css({'transition':'0.5s','opacity':'0.7'});
        $('.prizeCrownLimeBottom').css({'transition':'0.5s', 'opacity':'0'});

    }, 2000)

    setTimeout(()=>{
        box.button.show('OG2Intro-4');
    }, 5250)

})

$('#btn-OG2Intro-4').click(function() {

    // calculator.tutorial.animateOG2mapActive = 0;

    map.opacity.main([1, 1, 1], 2);
    map.opacity.section([0.2,0.2, 0.2], 1)

    box.transition('OG2Intro-4', 'OG2Intro-5', 0, 0, 1, 3250);

    setTimeout(()=>{
        $('.IGBottomContestWrap').css({'transition':'0.5s','opacity':'0.2'});
        $('.mapdiscardedXBottom').css({'transition':'0.5s','opacity':'0.2'});
        map.opacity.arrowsFromResultIcons([1,0], [0, 1]);
        map.opacity.arrowsFromIG([1,0]);
        $('.arrowsToOG2').css({'transition':'0.5s', 'opacity' : '1'});
    ...
    setTimeout(()=>{
        ...
        $('.IGLeftFollower1, .prizeCrownLimeTop').css({'transition':'0.5s', 'opacity':'0.6'})

        $('.bottomBoxLeaderResult').css({'transition':'0.5s', 'opacity':'0.6'});
        $('.arrowToBottomIconResults').css({'transition':'0.5s', 'opacity':'0.6'});
        map.opacity.arrowsFromResultIcons([0.7, 0], [0, 0.7]);
        $('.arrowsToOG2').css({'transition':'0.5s', 'opacity' : '0.7'});
    }, 1500)

    setTimeout(()=>{

        $('.topBoxLeaderResult').css({'transition':'0.5s', 'opacity':'0.6'});
        $('.arrowToTopIconResults').css({'transition':'0.5s', 'opacity':'0.6'});

        $('.IGLeftFollower2').css({'transition':'0.5s', 'opacity':'0.6'})
    ...
    setTimeout(()=>{
        // show the initial setup for comparison
        $('.OG1FollowersWrapLeft').css({'transition':'0.95s', 'opacity': '0.8'});
        $('.OG1FollowerArrowsLeft').css({'transition':'0.95s', 'opacity': '0.8'});
        $('.OG1LeaderLeft').css({'transition':'0.95s', 'opacity':'0.6'});
        $('.s2PassiveFollower').css({'transition':'0.95s', 'opacity':'1'});
        $('.subsubOG1L').css({'border-color':'gray'});

        // show the initial setup for comparison
        $('.OG1FollowersWrapRight').css({'transition':'0.95s', 'opacity': '0.6'});
        $('.OG1FollowerArrowsRight').css({'transition':'0.95s', 'opacity': '0.6'});
        $('.OG1LeaderRight').css({'transition':'0.95s', 'opacity':'0.6'});
        $('.s2PassiveFollower').css({'transition':'0.95s', 'opacity':'1'});
        $('.OG1RightFollower1, .OG1RightFollower2').css({'transition':'0.95s', 'opacity':'0.8'});
        $('.subsubOG1L').css({'border-color':'gray'});

        $('.OG1FightIconWrap').css({'transition':'0.95s', 'opacity':'0.6'});
        $('.OG1FightIcon').css({'transition':'0.95s', 'opacity':'1'});
        $('.OG1FightIconLime').css({'transition':'0s','opacity':'0'});

        $('.winnerLeaderArrowLeft, .winnerLeaderTextLeft ').css({'transition':'1s',  'opacity':'1'});
        // $('.OG2CircleArrowLeft_f1').css({'transition':'1s',  'opacity':'0.5'});
        // $('.OG2CircleArrowTextLeft_f1').css({'transition':'1s',  'opacity':'0.7'});
    }, 3000)

    setTimeout

    setTimeout(()=>{
        box.button.show('OG2Intro-5');
    }, 4500)

})

$('#btn-OG2Intro-5').click(function() {
    ...
    setTimeout(()=>{
        ...
        title.update.size(false);
        $('.sexplain').css({'margin-top':'45px', 'margin-bottom':'-175px'});
        ...
        setTimeout(()=>{
            ...
            // $('#boxbox-OG2').css({'margin-top':'20px'});
...
$('#btn-OG2-1').click(function() {
    ...
    box.transition('OG2-1', 'OG2-101', 0, 0, 1, 750);

    calculator.roll.resetRoll();

    setTimeout(()=>{
        calculator.values.set.helpSabo([0,0,0,11,0,0,5,6]);
        calculator.values.set.efforts([200,200]);
        calculator.refresh.sliders();
        calculator.graphics.update.pie();
        calculator.refresh.values();
    ...
    setTimeout(()=>{
        box.button.show('OG2-101');
    }, 3000)


})

$('#btn-OG2-101').click(function() {

    box.transition('OG2-101', 'OG2-2', 0, 0, 1, 750);
    ...
    setTimeout(()=>{
        ...
        listener.og2_2_f1 = true;
        // listener.og2_2_f2 = true;
        // listener.og2_2_of1 = true;
        // listener.og2_2_of2 = true;
    }, 1000)
...
$('#btn-OG2-201').click(function() {
    ...
    // s1,s2,h1,h2,os1,os2,oh1,oh2
    calculator.values.set.helpSabo([0,0,12,11,0,0,5,6]);
    calculator.refresh.sliders();
    calculator.hide.checkMark();
...
$('#btn-OG2-3').click(function() {
    ...
    $('.generalMarginBox').css({'margin-top':'-100px'});
...
$('#btn-OG2-4').click(function() {

    box.transition('OG2-4', 'OG2-5', 0, 0, 1, 750);
    calculator.button.enable.spinBottom();
...
$('#btn-OG2-5').click(function() {
    ...
    setTimeout(()=>{
        listener.ig2_6_l1 = true;
        listener.ig2_6_l2 = true;
        calculator.pointers.activate([1,1,0,0,0,0]);
    }, 1250)

})

$('#btn-OG2-601').click(function() {

    box.transition('OG2-601', '', 0, 0, 1, 0);
    $('#boxbox-OG2').css({'transition':'0.5s', 'margin-bottom':'-33px'});
    ...
    setTimeout(()=>{
        ...
        setTimeout(()=>{
            $('.generalMarginBox').css({'margin-top':'-34px'});
        }, 2010)
    }, 750)

    setTimeout(()=>{
        box.transition('', 'OG2-7', 0, 0, 1, 0);
        $('#boxbox-OG2').css({'transition':'0.5s', 'margin-bottom':'15px'});
        $('.generalMarginBox').css({'transition':'1s', 'transform':'scale(0.8)', 'margin-top':'-20px'});
        $('#boxbox-OG2').css({'transition':'1s', 'transform':'scale(1.25)'});
        calculator.lock.activate([0, 0, 0, 0, 0, 0]);
    }, 6000)

    setTimeout(()=>{
        box.button.show('OG2-7');
    }, 8000)

})

$('#btn-OG2-7').click(function() {

    box.transition('OG2-7', 'OG2-8', 0, 0, 1, 750);

    setTimeout(()=>{
        box.button.show('OG2-8');
    }, 3000)

})

$('#btn-OG2-8').click(function() {

    box.transition('OG2-8', 'OG2-9', 0, 0, 1, 750);

    setTimeout(()=>{
        box.button.show('OG2-9');
    }, 3000)

})

$('#btn-OG2-9').click(function() {
...
$('#vSlider1').change(function() {
    ...
    if(activator.og2_2_f1 && (h1 >= 8 && h1 <= 20)) {
